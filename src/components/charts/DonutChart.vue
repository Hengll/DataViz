<template>
  ...
  <Doughnut id="my-chart-id" :style="style" :options="chartOptions" :data="chartData"></Doughnut>
</template>
...
const chartOptions = computed(() => {
  // 確保 computed 會重新計算
  const donutColor = [].concat(
    editor.dashboard.charts[props.indexOfChart].chartOption.donutChart.donutColor,
  )
  return {
    responsive: true,
