...
export default {
  ...
  editDrawer: {
    ...
    indexAxis: '柱狀圖方向',
    barColor: '柱狀圖顏色',
    barBorderWidth: '柱狀圖邊框寬度',
    barBorderColor: '柱狀圖邊框顏色',
    barBorderRadiusTopLeft: '柱狀圖圓角 - 左上',
    barBorderRadiusTopRight: '柱狀圖圓角 - 右上',
    barBorderRadiusBottomLeft: '柱狀圖圓角 - 左下',
    barBorderRadiusBottomRight: '柱狀圖圓角 - 右下',
    inflateAmount: '柱狀圖膨脹比例',
    titleDisplay: '是否顯示標題',
    titlePosition: '標題位置',
    titleAlign: '標題對齊方式',
    titleColor: '標題顏色',
